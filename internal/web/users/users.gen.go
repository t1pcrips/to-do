...
// PatchUsersParams defines parameters for PatchUsers.
...
type ServerInterface interface {
	...
	// (PATCH /users)
	PatchUsers(ctx echo.Context, params PatchUsersParams) error
	// Create a new user
	// (POST /users)
...
func (w *ServerInterfaceWrapper) PatchUsers(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PatchUsers(ctx, params)
	return err
}
...
type PostUsers201JSONResponse IdResponse
...
func (sh *strictHandler) PatchUsers(ctx echo.Context, params PatchUsersParams) error {
