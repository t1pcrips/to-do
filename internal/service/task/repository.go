...
func (repo *TaskRepository) CreateTask(task *api.Task) (*api.Task, error) {
...
func (repo *TaskRepository) GetAllTasks() ([]api.Task, error) {
	var tasks []api.Task
...
func (repo *TaskRepository) UpdateTask(task *api.Task) (*api.Task, error) {
...
func (repo *TaskRepository) DeleteTask(id uint) error {
	result := repo.Database.DB.Table("tasks").Delete(&api.Task{}, id)
	if result.Error != nil {
		return result.Error
	}
	return nil
...
func (repo *TaskRepository) FindByIdTask(id uint) (*api.Task, error) {
	var task api.Task
